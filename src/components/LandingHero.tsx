...
const LandingHero = () => {
  ...
  return (
    <div ref={heroSectionRef} className="relative flex min-h-screen items-center overflow-hidden bg-hero-gradient">
      ...
      <div className="relative z-10 flex w-full cursor-none items-center justify-between px-8 md:px-16 lg:px-24">
        ...
        <div className="max-w-3xl">
          ...
          <motion.h1
            className="mb-0 text-5xl font-medium leading-[1.05] tracking-tight text-foreground md:text-7xl lg:text-8xl"
          ...
          <motion.h2
            className="mb-8 text-5xl font-medium leading-[1.05] tracking-tight md:text-7xl lg:text-8xl"
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="hidden flex-col items-end gap-10 md:flex">
          {stats.map((stat, i) => (
            ...
            >
              <p className="text-4xl font-medium text-foreground lg:text-5xl" style={{ fontFamily: "var(--font-display)" }}>
                {stat.value}
              </p>
